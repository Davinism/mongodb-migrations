...
public class MigrationException extends UsefulException {
    ...
    public MigrationException(String title, String description, Throwable cause) {
    ...
    public MigrationException(String title, String description) {
     ...
     */
    public static abstract class ExceptionSource extends MigrationException {
     ...
     */
    public static abstract class ExceptionAttachment extends MigrationException {
